...
def train_isolation_forest():
    ...
    logging.info("Starting IsolationForest training")
    ...
    joblib.dump(iforest, f'{MODEL_STORAGE_PATH}/isolation_forest.pkl')

    logging.info("IsolationForest model trained and saved successfully")
